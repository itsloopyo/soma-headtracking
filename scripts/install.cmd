...
:: --- CONFIG BLOCK ---
set "GAME_ID=soma"
set "MOD_DISPLAY_NAME=SOMA Head Tracking"
set "MOD_DLLS=SomaHeadTracking.asi"
set "MOD_INTERNAL_NAME=SomaHeadTracking"
...
:: Soma.exe imports none of them directly; SDL2.dll, which it loads out of the
:: exe directory, imports VERSION.dll, WINMM.dll and DXGI.DLL.
...
set "MOD_CONTROLS=Controls:&echo   End       - Toggle head tracking on/off&echo   Page Up   - Cycle tracking mode&echo   Page Down - Toggle world-locked / camera-local yaw"
:: --- END CONFIG BLOCK ---
